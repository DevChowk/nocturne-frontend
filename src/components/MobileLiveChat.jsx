...
export default function MobileLiveChat({ messages, peerLabel }) {
  ...
  return (
    ...
    <div className="md:hidden absolute right-0 bottom-0 z-20 max-w-[75%] pointer-events-none">
      <div
        ...
        {reversed.map((msg, i) => {
          ...
          return (
            <div
              ...
              className="bg-black/55 backdrop-blur-md rounded-full px-3 py-1 max-w-full text-[13px] leading-snug break-words [overflow-wrap:anywhere] text-left flex-shrink-0"
              style={{ opacity: cap }}
            >
